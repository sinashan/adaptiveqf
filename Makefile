CTARGETS=test_micro test_correctness test_throughput test_split_throughput test_adversarial test_splinter_lltable_throughput test_splinter_parallel test_parallel test_qfdb test_qfdb_adversarial # test_fill_varied_throughput test_near_full test_deletions test_merge test_hash_accesses test_bulk test_whitelist test_resize test_micro_throughput test_micro_write test_micro_read test_lltable_throughput
...
test_qfdb_adversarial:              $(OBJDIR)/test_qfdb_adversarial.o $(OBJDIR)/gqf.o $(OBJDIR)/gqf_file.o \
                                    $(OBJDIR)/hashutil.o $(OBJDIR)/qf_uthash.o $(OBJDIR)/ll_table.o \
                                    $(OBJDIR)/splinter_util.o $(OBJDIR)/partitioned_counter.o
...
$(OBJDIR)/test_qfdb_adversarial.o:               $(LOC_INCLUDE)/gqf.h $(LOC_INCLUDE)/qf_uthash.h \
                                     $(LOC_INCLUDE)/hashutil.h \
                                     $(LOC_INCLUDE)/splinter_util.h
