CTARGETS=test_micro test_rehash_perf_two_filter test_rehash_perf_naive test_throughput test_split_throughput test_adversarial test_splinter_lltable_throughput test_splinter_parallel test_parallel test_qfdb test_qfdb_rehash# test_fill_varied_throughput test_near_full test_deletions test_merge test_hash_accesses test_bulk test_whitelist test_resize test_micro_throughput test_micro_write test_micro_read test_lltable_throughput
...
test_correctness:						$(OBJDIR)/test_correctness.o $(OBJDIR)/gqf.o $(OBJDIR)/gqf_file.o \
										$(OBJDIR)/hashutil.o $(OBJDIR)/splinter_util.o $(OBJDIR)/test_driver.o \
										$(OBJDIR)/partitioned_counter.o $(OBJDIR)/ll_table.o $(OBJDIR)/rand_util.o
...
test_rehash_correctness:			$(OBJDIR)/test_rehash_correctness.o $(OBJDIR)/gqf.o $(OBJDIR)/gqf_file.o \
                                    $(OBJDIR)/hashutil.o $(OBJDIR)/qf_splinterdb.o $(OBJDIR)/ll_table.o \
                                    $(OBJDIR)/splinter_util.o $(OBJDIR)/partitioned_counter.o

test_rehash_perf_naive: 			$(OBJDIR)/test_rehash_perf.o $(OBJDIR)/gqf.o $(OBJDIR)/gqf_file.o \
                                    $(OBJDIR)/hashutil.o $(OBJDIR)/qf_splinterdb_rehash_naive.o $(OBJDIR)/ll_table.o \
                                    $(OBJDIR)/splinter_util.o $(OBJDIR)/partitioned_counter.o

test_rehash_perf_two_filter: 		$(OBJDIR)/test_rehash_perf.o $(OBJDIR)/gqf.o $(OBJDIR)/gqf_file.o \
                                    $(OBJDIR)/hashutil.o $(OBJDIR)/qf_spinterdb_rehash_two_filter.o $(OBJDIR)/ll_table.o \
                                    $(OBJDIR)/splinter_util.o $(OBJDIR)/partitioned_counter.o
...
$(OBJDIR)/qf_splinterdb_rehash_naive.o: $(LOC_SRC)/qf_splinterdb_rehash_naive.c $(LOC_INCLUDE)/qf_splinterdb.h
$(OBJDIR)/qf_spinterdb_rehash_two_filter.o: $(LOC_SRC)/qf_spinterdb_rehash_two_filter.c $(LOC_INCLUDE)/qf_splinterdb.h
